...
class MapVisualization:
    ...
    def __init__(self):
        ...
        #changed from clicked point to localization
        self.odometry_sub = rospy.Subscriber("/sensors/localization/filtered_map", Odometry, self.getOdometry, queue_size=10)
    ...
    def getOdometry(self, point_msg):
        i = 2
        ...
        for lane in self.map.lanes:
            ...
            msg.color.b = 0.0
            msg.color.g = 1.0
            p, param = lane.lookahead_point(point, 1.5)
            msg.pose.position.x = p[0][0]
            msg.pose.position.y = p[0][1]
            msg.id = i
